...
public class infinitywar extends javax.swing.JFrame implements MouseListener {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(infinitywar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new infinitywar().setVisible(true);
            }
        });
    }
